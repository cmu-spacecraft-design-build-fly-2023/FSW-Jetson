...
def get_CART_from_OSC(x_oe: List[Union[float, int]], degrees: bool = False) -> np.ndarray:
    """
...
def get_OSC_from_CART(x_oe: List[Union[float, int]], degrees: bool = False) -> np.ndarray:
    """
